...
#' \pkg{OpenBUGS}) so that all adaptive updating is done during the burnin
#' stage. Otherwise \pkg{OpenBUGS} will not report results if the burnin is
...
#' @param bugs.directory directory that contains the \pkg{OpenBUGS} executable
