...
#' 
#' Write file \file{script.txt} for \pkg{OpenBUGS} to read - intended for
#' internal use
#' 
#' 
...
#' \code{model.file.bug} receives/contains the OpenBUGS program image for
...
#' @param debug if \code{FALSE}, \pkg{OpenBUGS} is closed automatically,
...
#' @param bugs.seed random seed for \pkg{OpenBUGS} (default is no seed
#' specified)
