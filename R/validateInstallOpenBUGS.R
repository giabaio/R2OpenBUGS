...
#' 
#' A selected subset of the examples from the OpenBUGS manual is executed and
...
#' \code{OpenBUGS.pgm} can be given in Windows path style (e.g.
#' \dQuote{c:/Program Files/OpenBUGS/}) or native (Unix) style \cr (e.g.
#' \dQuote{/path/to/wine/folder/dosdevices/c:/Program
#' Files/OpenBUGS/OpenBUGS321/OpenBUGS.exe}).
#' 
#' @param OpenBUGS.pgm See \code{\link{bugs}}.
#' @param useWINE logical; attempt to use the Wine emulator to run
#' \pkg{OpenBUGS}. Default is \code{FALSE}. If WINE is used, the arguments
#' \code{OpenBUGS.pgm} and \code{working.directory} must be given in form of
